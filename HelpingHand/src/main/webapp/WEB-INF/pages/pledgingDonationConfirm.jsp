...
<div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                   <div class="example-one8" style="text-align:center"><b> Pledge a donation
to PM relief fund
</b></div>
...
<!-- ITEM END -->
    ...
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-duration="3s">
                    <div class="example-one9" style="text-align:center"><b> INR ${amount} </b></div>
    ...
    <form name="form1" method="post" action="pledgingsubmit">
  ...
  <div class="row" data-wow-duration="3s">
    ...
    <div style="float:left;padding-top:25px;padding-left:35px" >
      <table width="307" height="147" border="1">
          ...
          <tr>
            <th bgcolor="#9999FF" scope="row">Detail</th>
            <td>${wishDetails}</td>
          </tr>
          <tr>
            <th height="34" bgcolor="#9999FF" scope="row">Remarks</th>
